...
public interface UsersApi {
    ...
    @Operation(
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "403", description = "Acc̬s refus̩", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))
            })
        },
        security = {
    ...
    default ResponseEntity<UserPage> searchUsers(
        ...
        return getDelegate().searchUsers(name, email, type, page, size);
    }
    ...
    default ResponseEntity<User> updateCurrentUser(
        ...
        return getDelegate().updateCurrentUser(updateUserRequest);
    }
    ...
    default ResponseEntity<User> updateUser(
        ...
        return getDelegate().updateUser(userId, updateUserRequest);
    }
